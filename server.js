...
app.post('/api/admin/auth', (req, res) => {
    ...
    console.log(`Auth attempt. Expected PIN length: ${ADMIN_PIN.length}. Received length: ${password ? password.length : 0}`);
    
    // Robust comparison (trims spaces from both)
    if (password && password.trim() === ADMIN_PIN.trim()) {
